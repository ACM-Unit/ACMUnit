...
<html lang="ru"><head>
    ...
    <script src="${CONTEXT}/index_files/modernizr-2.6.2.min.js"></script>
    <script src="${CONTEXT}/index_files/slider.js"></script>
    ...
    <script src="${CONTEXT}/index_files/jquery.bxslider.min.js"></script>
    ...
    <script type="text/javascript" src="${CONTEXT}/index_files/mootools-1.2.4-core-yc.js"></script>
    <script type="text/javascript" src="${CONTEXT}/index_files/mootools-1.2.4.4-more.js"></script>
    ...
    <link href="${CONTEXT}/index_files/style.css?1387573060105" type="text/css" rel="stylesheet">
    <link href="${CONTEXT}/index_files/style.css?1399894004108" type="text/css" rel="stylesheet">
    <link href="${CONTEXT}/index_files/style.css?1411982569261" type="text/css" rel="stylesheet">
    <link href="${CONTEXT}/index_files/styles.css?1435054669561" type="text/css" rel="stylesheet">
    <link href="${CONTEXT}/index_files/jquery.css" type="text/css" rel="stylesheet">
    <link href="${CONTEXT}/css/jquery.bxslider.css" type="text/css" rel="stylesheet">
    <link href="${CONTEXT}/index_files/template_styles.css?143505466943521" type="text/css" data-template-style="true" rel="stylesheet">
    ...
    <script type="text/javascript" src="${CONTEXT}/index_files/core.js?139644672478601"></script>
    <script type="text/javascript" src="${CONTEXT}/index_files/core_ajax.js?139332807529674"></script>
    <script type="text/javascript" src="${CONTEXT}/index_files/session.js?13964467242880"></script>
    <script type="text/javascript" src="${CONTEXT}/index_files/core_popup.js?139644672438525"></script>
    ...
    <script src="${CONTEXT}/index_files/script.js"></script>
...
<script>
    $(function() {
        var slider = $('.bxslider'),
                ...
                slideWidth = $('.bx-viewport').outerWidth(),         // Ширина слайдера
                slideCount = $('.bxslider li').length-3,
                prev = $('.bx-viewport .previ'),                      // Кнопка "назад"
                next = $('.bx-viewport .nexti'),                      // Количество слайдов
                sliderInterval = 9000,                              // Интервал смены слайдов
                animateTime = 1000,                                 // Время смены слайдов
                course = 1,                                         // Направление движения слайдера (1 или -1)
                margin = -slideWidth;                              // Первоначальное смещение слайдов
        $('.bxslider li:last').clone().prependTo('.bxslider');   // Копия последнего слайда помещается в начало.
        $('.bxslider li').eq(1).clone().appendTo('.bxslider');   // Копия первого слайда помещается в конец.
        $('.bxslider').css('margin-left', -slideWidth);         // Контейнер .slider сдвигается влево на ширину одного слайда.
